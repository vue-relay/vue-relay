...
import { __internal, isRelayModernEnvironment, getFragment, getRequest, deepFreeze, createOperationDescriptor, createFragmentSpecResolver, getDataIDsFromObject, isScalarAndEqual, ConnectionInterface, Observable, getFragmentOwners, getVariablesFromObject, MutationTypes, RangeOperations, applyOptimisticMutation, commitLocalUpdate, commitMutation, fetchQuery as fetchQuery$1, graphql, requestSubscription } from 'relay-runtime';
export { MutationTypes, RangeOperations, applyOptimisticMutation, commitLocalUpdate, commitMutation, fetchQuery, graphql, requestSubscription } from 'relay-runtime';
...
var index_esm = {
  ...
  fetchQuery: fetchQuery$1,
  graphql: graphql,
  requestSubscription: requestSubscription
};

export default index_esm;
export { VueRelayQueryRenderer as QueryRenderer, createFragmentContainer, createPaginationContainer, createRefetchContainer };
